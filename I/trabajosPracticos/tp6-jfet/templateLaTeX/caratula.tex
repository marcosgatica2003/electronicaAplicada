...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node [line width=2pt] at (7.5cm, -9cm) {\includegraphics[width=0.3\linewidth]{./imagenes/caratula.png}};
    ...
    \node at (7.5cm, -14cm) {\scalebox{3}{\textbf{Trabajo práctico 5}}};
    \node at (7.5cm, -15.5cm) {\scalebox{3}{TIRISTORES}};
	...
	\begin{minipage}[c]{12cm}
	    \begin{itemize}
            ...
            \item \fontsize{12}{12}\selectfont \textbf{Autores:}
                \begin{itemize} 
                    \item Manuel León Parfait - Leg. 406599 (Coordinador) 
                    \item Marcos Raúl Gatica - Leg. 402006 (Operador) 
                    \item Valentino Rao - Leg. 402308 (Documentador)
                \end{itemize}
            \item \fontsize{12}{12}\selectfont \textbf{Curso:} 3R1  \\
            \item \fontsize{12}{12}\selectfont \textbf{Docentes:} Francisco Hugo Sigampa y Luis Guanuco
