...
\textbf{Parámetro}                & \textbf{Valor Calculado} & \textbf{Valor Medido} \\ \hline
\cellcolor[HTML]{FFCCC9}$V_{DSQ}$ & $6 V$                      & $6,12 V$              \\ \hline
\cellcolor[HTML]{FFCCC9}$I_{DQ}$  & $3.325mA$                & $3,144mA$
\end{tabular}
\end{table}
