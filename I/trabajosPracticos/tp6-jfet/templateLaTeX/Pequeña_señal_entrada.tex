...
$$g_m = \left(-\frac{2(6,650\text{ mA})}{1,402\text{ V}}\right) \left(1-\frac{-0,4106\text{ V}}{1,402\text{ V}}\right) = (-9,486\text{ mS}) \cdot (1 + 0,2929) \quad \rightarrow \quad g_m \approx -12,26\text{ mS}$$
$$A_v = -(-12,26\text{ mS}) \cdot \SI{1681,51}{\ohm} \quad \rightarrow \quad A_v \approx 20,62$$

\sangria{La ganancia de corriente se calcula como la relación entre el $g_{m}$ multiplicado $R_{g}$:}
$$A_i = -g_{m} \cdot R_{G} \quad \rightarrow \quad A_i = 12,26 mS \cdot 1\ M\Omega \quad \rightarrow \quad A_i \approx12264,71 $$
